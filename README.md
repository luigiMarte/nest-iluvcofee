...
We will use the coffees module as example.

\*\* -dry-run at the end of the command will run it on test mode : nest g co coffee --dry-run
\*\* --no-spec at the end of the command will not generate test files
